...
The September 2026 sync incorporates the upstream work from common ancestor `70a28994` through `18c4459d`: API endpoint fixes, structured Cloudflare AI output handling, the v4 song model bump, Suno session-flow updates, and preservation of missing song-status rows.
